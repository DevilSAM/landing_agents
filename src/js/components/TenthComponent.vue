<template>
    <section class="secondary-background mb-0">
        <div class="max-width-container section-10">
            <h1 class="title">Посмотрев наши закрытый <br class="d-none d-lg-block">урок, ты узнаешь:</h1>
            <ul class="mt-0 ps-md-3 ps-0">
                ...
                <li class="disc-left">почему важно правильно выбрать компанию для успешного старта</li>
