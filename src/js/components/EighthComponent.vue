            ...
            <div class="vacation-block">
                <div class="vacation-card">
                    ...
                    <ul>
                        ...
                        <li class="disc-left">отдыху на природе</li>
                        <li class="disc-left">любимому занятию</li>
                        <li class="disc-left">глубокой релаксации</li>
                        <li class="disc-left">посещению интересных мероприятий</li>
                    </ul>
                ...
                <div class="vacation-card">
                    ...
                    <ul>
                        ...
                        <li class="disc-left">Заводи интересные знакомства</li>
                        <li class="disc-left">Пробуй что-то новое</li>
                        <li class="disc-left">Посвяти время заботе о себе</li>
                        <li class="disc-left">Занимайся тем, что делает тебя счастливым</li>
                    </ul>
                    <p>Не нужно целый год копить на отпуск.</p>
                    <p>Твои доходы и наша политика отпусков, позволят сделать путешествия и полноценный отдых частью твоей жизни.</p>
                </div>
            </div>
        </div>
    </section>
