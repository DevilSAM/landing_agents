        ...
        <div class="max-width-container section-9">
            <div class="top">
                <div class="top-left">
                    ...
                    <ul>
                        <li class="disc-left">впустую тратят 2-3 месяца на попытки заработать</li>
                        <li class="disc-left">разочаровываются в сфере и в своих способностях</li>
                        <li class="disc-left">уходят с пустыми карманами искать другую работу</li>
                    </ul>
                </div>
                <div class="top-right">
            ...
            <div class="bottom">
                <h2 class="bottom-left">Поэтому, если думаешь стать экспертом в недвижимости с доходом от 300 000 рублей в месяц, твой первый и самый важный шаг – это получить реальное представление о работе и <span class="text-primary">честно ответить себе на вопросы:</span></h2>
                <div class="bottom-right">
                    <img src="src/images/icons/arrows.png" alt="" height="32px" class="d-none d-md-block">
                    <ol>
